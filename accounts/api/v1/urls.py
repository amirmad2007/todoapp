...
urlpatterns = [
    ...
    path('email-verification/resend/' , ResendVerificationApiView.as_view() , name = 'resend_verification'),
    path('request-to-rest-password/' , RequestResetPasswordApiView.as_view() , name = 'request_to_rest_password'),
    path('reset-password/<str:token>' , ResendPasswordApiView.as_view() , name = 'reset_password')
]
